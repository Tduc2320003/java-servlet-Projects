...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            ...
            <h2 class="mb-3">Paddlefoot - The Second CD</h2>
            ...
            <table class="table">
                ...
                <tr>
                    <td>Neon Lights</td>
                    <td><a href="./sound/${productCode}/neon.mp3" target="_blank">MP3</a></td>
                </tr>
                <tr>
                    <td>Tank Hill</td>
                    <td><a href="./sound/${productCode}/tank.mp3" target="_blank">MP3</a></td>
                </tr>
                </tbody>
            </table>
