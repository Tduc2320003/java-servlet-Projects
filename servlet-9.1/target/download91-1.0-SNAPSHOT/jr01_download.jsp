...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            ...
            <h2 class="mb-3">Joe Rut - Genuine Wood Grained Finish</h2>
            ...
            <table class="table">
                ...
                <tr>
                    <td>Filter</td>
                    <td><a href="./sound/${productCode}/filter.mp3" target="_blank">MP3</a></td>
                </tr>
                <tr>
                    <td>So Long Lazy Ray</td>
                    <td><a href="./sound/${productCode}/so_long.mp3" target="_blank">MP3</a></td>
                </tr>
                </tbody>
            </table>
